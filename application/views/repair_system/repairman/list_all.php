...
<a href="<?= base_url(); ?>repair_system/repairman/list_all?start_date=<?= isset($_GET['start_date']) ? $_GET['start_date']  : date('Y-m-d', strtotime('-3 month')); ?>
		...
		<tr>
			...
			<td style="font-size: 13px;">
				...
				<div class="modal-footer">
					<button type="button" style="color: black; font-size: 18px;" class="btn btn-secondary" data-dismiss="modal">ปิด</button>
				</div>
