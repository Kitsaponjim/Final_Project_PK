...
<div class="content-wrapper">
    ...
    <i class="fa fa-plus"></i>&nbsp; เพิ่มประเภทงานแจ้งซ่อม
</p>												
									<br>
				...
				<div class="col-md-12 mt-2">
					<div class="button-container">
						...
						<input type="button" value="ย้อนกลับ" class="btn btn-custom rounded-0"
							onclick="window.location='<?= base_url(); ?>repair_system/repairman/list_type'">
		...
		if (rp_type == "") {
			...
			$.ajax({
				...
				success: function (data) {
					...
					window.location = "<?= base_url(); ?>repair_system/repairman/list_type";
				}
			});
			return false;
		}
