						...
						<form class="form-horizontal">
							<div class="box-body">
								<div class="col-sm-8">
									...
									<p
										style="font-size: 20px; background-color: #f2f2f2; padding: 4px; border-radius: 5px;">
										&nbsp;<i class="fa fa-user"></i>
										&nbsp;&nbsp;ข้อมูลแจ้งซ่อม</p>

									<div class="form-group">
										<div class="col-sm-3 control-label">
											<label class="label-font"></strong>ชื่อ-นามสกุล : </label>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3 control-label">
											<label  class="label-font"></strong>เบอร์โทรศัพท์มือถือ : </label>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3 control-label">
											<label class="label-font"></strong>อีเมล: </label>
										</div>
									...
									<div class="form-group">
										<div class="col-sm-3 control-label">
											<label class="label-font">ประเภทงานซ่อม: </label>
										</div>
								...
								?>
									...
									<div class="form-group">
										<div class="col-sm-3 control-label">
											<label class="label-font">ชื่ออุปกรณ์: </label>
										</div>
										<div class="col-sm-7">
									...
									<div class="form-group">
										<div class="col-sm-3 control-label">
											<label class="label-font">รายละเอียดปัญหา: </label>
										</div>
									...
									<div class="form-group">
										<div class="col-sm-3 control-label">
											<label class="label-font">สถานที่แจ้งซ่อม: </label>
										</div>
									...
									<div class="form-group">
										<div class="col-sm-3 control-label">
											<label class="label-font">รายละเอียดสถานที่: </label>
										</div>
					...
					<div class="col-md-12 mt-2">
						<div class="button-container">
							<input class="btn btn-custom" type="submit" name="btnSave" id="btnSave"
								style="background-color: #4281ff; color:white; font-size:16px;" value="บันทึกข้อมูล"
							...
							<input type="button" value="ย้อนกลับ" class="btn btn-custom rounded-0"
								...
								onclick="window.location='<?= base_url(); ?>repair_system/admin/list_repair'">
