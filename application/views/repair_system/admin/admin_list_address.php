...
<div class="content-wrapper">
    ...
    <p style="font-size: 20px; background-color: #ffffff; padding: 10px; border-radius: 10px; display: flex; align-items: center;">
        ...
        <strong style="flex: 1; display: inline;">รายการสถานที่</strong>

		<a class="btn btn-custom" style="background-color: #4281ff; color:white;" href="<?= site_url('repair_system/admin/admin_add_address'); ?>"
			...
			<div class="box-body">
				<div class="row">
					...
					<!-- <div class="col-sm-6 d-flex justify-content-between">
						<a class="btn btn-custom" style="background-color: #4281ff; color:white;" href="<?= site_url('repair_system/admin/admin_add_type'); ?>"
						...
						<table id="example1" class="table table-bordered table-striped dataTable" role="grid" style="font-size: 16px;"
							...
							<tbody>
								...
								foreach ($query as $value) {
									...
									$rp_name_type = $value->name_address;
									?>
									...
									<tr role="row">
										...
										<td align="center" style="font-size: 15px;">
											<a href="#" class="" onclick="onEdit(<?= $id_address ?>)">
												<i class="fa fa-edit" style="color: black; font-size: 18px;"></i>
											</a>
											&nbsp;	&nbsp;
											<a href="#" class="btn btn-custom" onclick="onDel(<?= $id_address ?>)">
...
<script>
	...
	function onEdit(id_address) {
		window.location = "<?= base_url(); ?>repair_system/admin/admin_edit_address/" + id_address;
	}

	function onDel(id_address) {
		// alert(id_address);
		if (confirm("คุณต้องการ ลบใช่หรือไม่")) {
			window.location = "<?= base_url(); ?>repair_system/admin/admin_del_address/" + id_address;
		}
	}
