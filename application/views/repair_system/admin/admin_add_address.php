...
<div class="content-wrapper">
    ...
    <i class="fa fa-plus"></i>&nbsp; เพิ่มรายการสถานที่
</p>
									...
									<div class="form-group">
										...
										<label><strong class="text-danger">*</strong>สถานที่
												:</label>
										</div>

										<div class="col-sm-7">
											<input type="text" id="rp_type" name="rp_type"
												class="form-control rounded-0 custom-placeholder" placeholder="สถานที่">
...
<script>
	function onSave() {
		...
		if (rp_type == "") {
			...
			$.ajax({
				url: "<?= base_url(); ?>repair_system/admin/add_address",
				type: 'POST',
				data: pmeters,
				async: false,
