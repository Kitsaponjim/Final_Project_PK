...
<p style="font-size: 15px; background-color: #ffffff; padding: 10px; border-radius: 10px; display: flex; align-items: center;">
	...
	<button class="btn btn-custom-gray btn-lg" style="font-size: 13px; margin-left:20px;" type="submit">ค้นหา</button>
			...
			<div class="row">
				...
				<div class="mt-4 col-lg-3 col-6">
					<div class="small-box" style="background-color: #ffb24f; border-radius: 5px;">
						...
						<br>
						<a href="<?= base_url(); ?>repair_system/employee/list_repair?status=1&start_date=<?= isset($_GET['start_date']) ? $_GET['start_date'] : ''; ?>&end_date=<?= isset($_GET['end_date']) ? $_GET['end_date'] : ''; ?>&id=<?= $id; ?>"
				...
				<div class="mt-4 col-lg-3 col-6">
					<div class="small-box" style="background-color: #4281ff; border-radius: 5px;">
						...
						<a href="<?= base_url(); ?>repair_system/employee/list_repair?status=2&start_date=<?= isset($_GET['start_date']) ? $_GET['start_date'] : ''; ?>&end_date=<?= isset($_GET['end_date']) ? $_GET['end_date'] : ''; ?>&id=<?= $id; ?>"
							class="small-box-footer rounded-0">
							ดูเพิ่มเติม <i class="fa fa-arrow-right"></i>
						</a>
				...
				<div class="mt-4 col-lg-3 col-6">
					<div class="small-box" style="background-color: #78d654; border-radius: 5px;">
						...
						<br>
						<a href="<?= base_url(); ?>repair_system/employee/list_repair?status=3&start_date=<?= isset($_GET['start_date']) ? $_GET['start_date'] : ''; ?>&end_date=<?= isset($_GET['end_date']) ? $_GET['end_date'] : ''; ?>&id=<?= $id; ?>"
							class="small-box-footer rounded-0">
							ดูเพิ่มเติม <i class="fa fa-arrow-right"></i>
						</a>
					</div>
				...
				<div class="mt-4 col-lg-3 col-6">
					<div class="small-box" style="background-color: #c7c7c7; border-radius: 5px;">
						...
						<br>
						<a href="<?= base_url(); ?>repair_system/employee/list_repair?status=4&start_date=<?= isset($_GET['start_date']) ? $_GET['start_date'] : ''; ?>&end_date=<?= isset($_GET['end_date']) ? $_GET['end_date'] : ''; ?>&id=<?= $id; ?>"
							class="small-box-footer rounded-0">
							ดูเพิ่มเติม <i class="fa fa-arrow-right"></i>
						</a>
			...
			<div class="box-body">
				...
				<div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
					<div class="row">
						...
						<div class="col-sm-7">
							<p
								style="font-size: 15px; background-color: #f2f2f2; padding: 10px; border-radius: 10px; display: flex; align-items: center;">
						...
						<div class=" col-sm-5">
							...
							<table id="table1" class="table table-bordered table-striped" role="grid"
								...
								<tbody>
									...
									WHERE rp_case.id_repair = 11 AND rp_case.rp_case_status = 1 AND id_repair = $id $whereCondition
