				...
				<div class="box-body">
					...
					<div class="col-sm-6">
						...
						<p style="font-size: 17px; background-color: #f2f2f2; padding: 4px; border-radius: 5px;"><i
								class="fa fa-user"></i> ข้อมูลการจองห้องประชุม</p>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" id="name_requester" name="name_requester"
									class="form-control rounded-0 custom-placeholder" value="<?= $name_requester ?>"
									readonly>
					...
					<style>
						...
						<p style="font-size: 17px; background-color: #f2f2f2; padding: 4px; border-radius: 5px;"><i
								class="fa fa-cogs"></i> ข้อมูลห้องประชุม</p>


								<div class="form-group" style="margin-top:30px;">
										<div class="col-sm-10">
											<label></strong>ชื่อห้องประชุม : </label>
											<?= $room_name; ?>
										</div>

										<div class="col-sm-10">
											<label></strong>สถานที่ของห้อง : </label>
											<?= $room_address; ?>
										</div>
										<div class="col-sm-10">
											<label></strong>ความจุ : </label>
											<?= $room_capacity; ?>
										</div>
										<div class="col-sm-10">
											<label></strong>ผู้ดูแลห้อง : </label>
											<?= $room_attendant; ?>
										</div>
										<div class="col-sm-10">
					...
					<div class="button-container">
						...
						<input type="button" value="ย้อนกลับ" class="btn btn-custom rounded-0" style="margin-right:15px"
								onclick="window.location='<?= base_url(); ?>superAdmin/room_list_all'">
		...
		if (confirm('คุณต้องการบันทึกข้อมูลใช่หรือไม่')) {
			...
			$.ajax({
				...
				success: function (data) {
					...
					window.location = "<?= base_url(); ?>superAdmin/room_list_all";
				}
			});
			return false;
