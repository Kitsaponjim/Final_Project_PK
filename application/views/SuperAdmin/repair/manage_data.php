<div class="content-wrapper">
						...
						<div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
							<div class="row">
									...
									<div class="box-body">
										<div class="col-sm-6">
											...
											<p style="font-size: 17px; background-color: #f2f2f2; padding: 4px; border-radius: 5px;"><i
											 ...
											 <label
												style="margin-bottom: 5px; margin-left:15px; font-weight: normal;">ประเภทงานซ่อม :&nbsp;
												&nbsp; &nbsp; </label>
												
											<input type="text" id="cus_name" name="cus_name"
												class="form-control rounded-0 custom-placeholder"
												style="width: 70%; padding-right: 30px;" value="<?= $rp_name_type; ?>"
												readonly>
											...
											&nbsp; &nbsp;  <label
												style="margin-bottom: 5px; margin-right: 10px; font-weight: normal;">รายละเอียดปัญหา
												:</label>
								...
								<div class=" col-sm-6">
									...
									<br>
									&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; <label
										style="margin-bottom: 5px;  font-weight: normal;"><strong class="text-danger">*</strong>อัพเดทสถานะ
										:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
    ...
    ?>
									...
									&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; <label
										style="margin-bottom: 5px; margin-right: 10px; font-weight: normal;"><strong class="text-danger">*</strong>บันทึกการอัพเดทงานซ่อม
										:</label><br>
									...
									&nbsp; &nbsp; &nbsp; <label
										style="margin-bottom: 5px; font-weight: normal;"><strong class="text-danger">*</strong>ลงชื่อผู้บันทึก :&nbsp; &nbsp;
										&nbsp; &nbsp; </label>
				...
				<div class="col-md-12 mt-2">
					<div class="button-container">
						...
						<input type="button" value="ย้อนกลับ" class="btn btn-custom rounded-0" style="margin-right:15px"
								onclick="window.location='<?= base_url(); ?>repair_system/admin/list_all'">
