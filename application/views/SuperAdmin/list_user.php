	...
	<div class="box custom-box">
		...
		<section class="content-header" style="display: flex; align-items: center;">
			...
			<div style="display: flex; justify-content: flex-end; flex-grow: 1;">
				<a class="btn btn-custom" style="background-color: #4281ff; color:white; margin-right:15px" href="#" role="button" data-toggle="modal" data-target="#popupModal">
					<i class="fa fa-fw fa-plus-circle"></i> รายการผู้ใช้</a>
			</div>
					...
					<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
						...
						<tbody>
							...
							foreach ($query['query'] as $value) {
								...
								$user_status_info = $value->user_status_info;
							...
							?>
								<tr role="row">
									...
									<td style="font-size: 12px; display: flex; justify-content: center; align-items: center;">
										<?php if ($user_status_info == 1) : ?>
											<div style="width: 10px; height: 10px; border-radius: 50%; background-color: #07db00;"></div>
										<?php else : ?>
...
<div class="modal fade" id="popupModal" tabindex="-1" role="dialog" aria-labelledby="popupModalLabel1" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="row" style="margin-top:12px;">
				<div class="col-md-12">
					...
					<div class="col-sm-7">
						<input type="text" id="user_login" name="user_login" placeholder="ชื่อผู้ใช้งาน" class="form-control rounded-0 custom-placeholder" value="" onblur="checkUsernameAvailability(this)">
						<span id="usernameAvailability" class="text-danger"></span>
					</div>
			...
			<div class="row" style="margin-top:12px;">
				<div class="col-md-12">
					...
					<div class="col-sm-7">
						<input type="password" id="user_password_1" name="user_password_1" placeholder="รหัสผ่าน" class="form-control rounded-0 custom-placeholder" value="">
					</div>
			...
			<div class="row" style="margin-top:12px;">
				<div class="col-md-12">
					...
					<div class="col-sm-7">
						<input type="password" id="user_password_2" name="user_password_2" placeholder="ยืนยันรหัสผ่าน" class="form-control rounded-0 custom-placeholder" value="">
					</div>
			...
			<div class="row" style="margin-top:12px;">
				<div class="col-md-12">
					...
					<div class="col-sm-7">
						<input type="text" id="user_name" name="user_name" placeholder="ชื่อ-นามสกุล" class="form-control rounded-0 custom-placeholder" oninput="validateName(this);">
			...
			<div class="row" style="margin-top:18px;">
				<div class="col-md-12">
					...
					<div class="col-sm-7">
						<input type="text" id="user_tel" name="user_tel" placeholder="เบอร์โทรศัพท์มือถือ" class="form-control rounded-0 custom-placeholder" maxlength="10" oninput="validatePhoneNumber(this);">
			...
			<script>
				...
				function checkUsernameAvailability(input) {
					...
					var userData = <?php echo $userData['userData']; ?>;
					var usernameAvailability = document.getElementById('usernameAvailability');

					for (var i = 0; i < userData.length; i++) {
						if (userData[i].user === username) {
							usernameAvailability.textContent = 'ชื่อผู้ใช้งานนี้มีอยู่ในระบบแล้ว';
							return false; // บอกให้ไม่สามารถบันทึกได้
						}
					}

					// ถ้าไม่มีชื่อผู้ใช้งานที่ซ้ำ
					usernameAvailability.textContent = '';
					return true; // บอกให้สามารถบันทึกได้
				}
			</script>
			...
			<div class="row" style="margin-top:12px;">
				<div class="col-md-12">
					...
					<div class="col-sm-7">
						<input type="text" id="user_email" name="user_email" placeholder="อีเมล" class="form-control rounded-0 custom-placeholder" value="">
					</div>
			...
			<div class="form-group">
				<textarea style="display: none;" id="car_id_r" name="car_id_r" class="form-control rounded-0"></textarea>
			</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-custom" id="saveChangesButton" style="background-color: #4281ff; color:white;" onclick="onAdd()">บันทึกข้อมูล</button>
...
<script>
	function onAdd() {
		...
		var isUsernameAvailable = checkUsernameAvailability();
		if (!isUsernameAvailable) {
			alert("ไม่สามารถบันทึกได้ เนื่องจากมีชื่อผู้ใช้งานที่ซ้ำกัน");
			return false;
		}
