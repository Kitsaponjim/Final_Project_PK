<div class="content-wrapper">
	<section class="content">
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<form action="<?= site_url('room_system/employee/admin_reserve_room'); ?>" method="post"
   ...
   <button class="btn btn-custom-gray btn-lg"  style="<?= ($room_status == 2) ? 'color: gray;' : 'color: while;'; ?> margin-right: 3px; font-size: 16px; margin-left:8px;"
							type="submit">จอง</button>
							

   <!-- <i class="fa fa-calendar-check-o"
      style="<?= ($room_status == 2) ? 'color: gray;' : 'color: black;'; ?> margin-right: 3px;"></i> -->
</a>
		...
		if (confirm('คุณต้องการบันทึกข้อมูลใช่หรือไม่')) {
			...
			$.ajax({
				...
				success: function (data) {
					...
					window.location = "<?= base_url(); ?>room_system/employee/admin_reserve_room";
				}
			});
			return false;
