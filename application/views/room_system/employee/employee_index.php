<div class="content-wrapper">
	<section class="content-header">
		<p style="font-size: 20px; background-color: #ffffff; padding: 10px; border-radius: 10px; display: flex; align-items: center;">
			...
			<strong style="flex: 1; display: inline;">ปฏิทินการใช้ห้อง </strong>
		</p>
...
<script>
	...
	function click(info) {
		...
		document.getElementById('eventName').innerText = 'ชื่อผู้จอง: ' + event.extendedProps.name; // น่าจะต้องเป็น event.title หรือ event.name_passengers
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		var calendar = new FullCalendar.Calendar(calendarEl, {
			...
			selectable: true,
			events: "<?php echo base_url('room_system/Admin/show_events'); ?>",
			eventColor: '#378006',
			eventTextColor :'#000',
			eventTimeFormat: {
				hour: 'numeric',
