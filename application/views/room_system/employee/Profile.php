<div class="content-wrapper">
    ...
    border-radius: 10px; /* ปรับค่าตามที่คุณต้องการให้เหมาะสม */
		...
		.custom-box {
						...
						<?php
						$n_status = $user_status['user_status']->name_room;
						...
						$user_status_room = $data['query']->user_status_room;
...
<p style="font-size: 20px; background-color: #f2f2f2; padding: 10px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
									...
									<div class="form-group">
										<div class="col-sm-3 control-label">
											<label></strong>ล็อกอินผู้ใช้ : </label>
										</div>
...
<script>
	function onEdit(id) {
		...
		window.location = "<?= base_url(); ?>room_system/employee/edit_profile/" + id;
