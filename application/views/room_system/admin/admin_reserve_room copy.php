				...
				<div class="row">
					...
					<div class="row" style="margin-top:10px;">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<label class="font-label" for=""><strong class="text-danger">*</strong>ลักษณะการใช้งาน</label>
								<input type="text" class="form-control" id="job_description" name="job_description"
									placeholder="ลักษณะการใช้งาน">
							</div>
		...
		numError.textContent = '';
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-custom" id="saveChangesButton"
					style="background-color: #4281ff; color:white;" onclick="onReserve()">บันทึกข้อมูล</button>
