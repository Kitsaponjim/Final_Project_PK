	...
	<section class="content-header">
		<p
			...
			<a href="#" class="btn btn-custom open-popup" data-toggle="modal"
				style="background-color: #ffb73b;color:white; font-size:16px;" data-target="#popupModal_time" role="button"
							...
							<div class="box custom-box">
								<div class="box-body">
									...
									<div>
										...
										<strong style="margin-left: 20px; margin-top:10px;font-size: 18px;">สถานที่ :</strong>
										...
										<br>
										<strong style="margin-left: 20px; margin-top:10px;font-size: 18px;">ผู้ดูแลห้อง :</strong>
										<span style="font-size:16px;">
									...
									<p style="font-size: 20px; display: flex; align-items: center; margin-top:5px;">
										...
										<a href="#" class="open-popup" data-toggle="modal" data-target="#popupModal_room"
											...
											<i class="fa fa-search" style="color: black; margin-right: 3px; font-size:18px;"></i>
										</a>
										...
										<a href="#" class="open-popup" data-toggle="modal" data-target="#popupModal_edit"
											...
											<i class="fa fa-edit" style="color: black; margin-right: 3px; font-size:18px;"></i>
										</a>
										...
										<a href="#" class="" onclick="onDel(<?= $room_id ?>)">
											<i class="fa fa-trash" style="color: black; margin-right: 7px;font-size:18px;"></i>
										</a>
						...
						?>
							...
							<div class="col-sm-12">
								...
								<div class="box-body"
									...
									<p style="font-size: 18px; color: #000;">ไม่มีข้อมูลห้องประชุม</p>
									<p style="font-size: 16px; color: #000;">เพิ่มข้อมูลห้องประชุม</p>
								</div>
								</div>
							</div>
							<?php
		...
		<div class="modal-content">
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label  class="font-label"for="room_name_edit">ชื่อห้องประชุม :</label>
						...
						<div class="form-group">
							<label  class="font-label"for="equipment_edit">อุปกรณ์ :</label>
							<div class="checkbox-container" id="equipment_edit" style="margin-top:10px;">
								<?php $count = 0; ?>
								<div class="form-check">
									<?php foreach ($equipment['equipment'] as $value): ?>
										<input type="checkbox" id="equipment_edit<?= $value->equipment_id; ?>"
											name="equipment[]" value="<?= $value->equipment_id; ?>">
										<label class="form-check-label" for="equipment_edit<?= $value->equipment_id; ?>">
						...
						<div class="form-group">
							<label class="font-label" for="room_address_edit">สถานที่ :</label>
							<input type="text" class="form-control" id="room_address_edit" name="room_address_edit"
								placeholder="สถานที่">
						</div>
						<div class="form-group">
							<label class="font-label" for="room_seating_edit">จำนวนที่นั่ง :</label>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="font-label" for="">ผู้ดูแลห้อง :</label>
						...
						<div class="form-group">
							<label class="font-label" for="">เบอร์โทรศัพท์มือถือ :</label>
							<input type="tel" class="form-control" id="room_attendant_tel_edit"
								name="room_attendant_tel_edit" placeholder="เบอร์โทรศัพท์มือถือ" maxlength="10"
						...
						<div class="form-group">
							<label class="font-label" for="room_readiness_edit">ความพร้อมใช้งาน :</label>
						...
						<div class="form-group">
							<label  class="font-label"for="room_note_edit">หมายเหตุ :</label>
					...
					<div class="col-sm-12">
						...
						<div class="mt-4 col-md-4 mb-2">
							<label  class="font-label"> แนบรูป </label>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-custom" id="saveChangesButton"
					style="background-color:#4281ff; color:#ffffff; font-size:16px;" onclick="onEdit('room_id')">บันทึกข้อมูล</button>
...
<div class="modal fade" id="popupModal_add" tabindex="-1" role="dialog" aria-labelledby="popupModalLabel2"
	...
	<div class="modal-dialog custom-width" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-6">
						<p style="font-size: 18px; color:back;"><strong> ข้อมูลห้องประชุม</span></strong></p>
						<div class="form-group">
							<label class="font-label" for="room_name"><strong class="text-danger">*</strong>ชื่อห้อง :</label>
						...
						<div class="form-group">
							<label class="font-label" for="equipment">อุปกรณ์ :</label>
						...
						<div class="form-group">
							<label class="font-label" for="room_address"><strong class="text-danger">*</strong>สถานที่ :</label>
							<input type="text" class="form-control" id="room_address" name="room_address"
								placeholder="สถานที่">
						</div>
						<div class="form-group">
							<label class="font-label" for="room_seating"><strong class="text-danger">*</strong>จำนวนที่นั่ง :</label>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="font-label" for=""><strong class="text-danger">*</strong>ผู้ดูแลห้อง :</label>
						...
						<div class="form-group">
							<label class="font-label" for=""><strong class="text-danger">*</strong>เบอร์โทรศัพท์มือถือ :</label>
						...
						<div class="form-group">
							<label class="font-label" for="room_status"><strong class="text-danger">*</strong>ความพร้อมใช้งาน :</label>
						...
						<div class="form-group">
							<label class="font-label" for="room_note">หมายเหตุ :</label>
					...
					<div class="col-sm-12">
						...
						<div class="mt-4 col-md-4 mb-2">
							<label  class="font-label"> <strong class="text-danger">*</strong>แนบรูป </label>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-custom" id="saveChangesButton"
					style="background-color:#4281ff; color:#ffffff; font-size:16px;" onclick="onAdd()">บันทึกข้อมูล</button>
				<button type="button" style="font-size:16px" class="btn btn-secondary" data-dismiss="modal">ปิด</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="popupModal_time" tabindex="-1" role="dialog" aria-labelledby="popupModalLabel2"
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<label for="start_time" style="font-size:16px;"><strong
									class="text-danger">*</strong>เวลาเริ่มต้น :</label>
							...
							<label for="end_time" style="font-size:16px; margin-left:26px;"><strong
									class="text-danger">*</strong>เวลาสิ้นสุด :</label>
	...
	<script>
		...
		function Edit_time() {
			...
			if (start_time !== '' && end_time !== '') {
				var start_time_sec = new Date("1970-01-01T" + start_time + "Z").getTime() / 1000;
				var end_time_sec = new Date("1970-01-01T" + end_time + "Z").getTime() / 1000;
			...
			if (confirm("คุณต้องแก้ไขระยะเวาลาการจองห้องประชุมใช่หรือไม่")) {
