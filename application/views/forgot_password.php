...
<div style="display: flex; justify-content: center;">
    <div class="col-sm-5" style="padding-top: 15px; margin-right: 10px;">
        <div class="box custom-box" style="border-radius: 10px; background-color: #ffffff; padding: 20px;">
		
            <section class="content-header" style="display: flex; align-items: center;">

<a href="<?= site_url('login'); ?>">
<i class="fa fa-arrow-left" style="margin-right: 10px; padding: 8px; border-radius: 50%; color: #007bff; font-size: 24px;"></i>
