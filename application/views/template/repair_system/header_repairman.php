...
<body class="hold-transition skin-red sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?= site_url('repair_system/repairman'); ?>" class="logo" style="background-color: white;">
	...
	<span style="color: green; font-size: small;">●</span>
        <strong><span style="font-size: small;">ช่างซ่อม</span></strong>  
    </div>
</span>
							</a>
							<ul class="dropdown-menu">
								<li>
									<a href="<?php echo site_url('repair_system/repairman/profile'); ?>"><i class="fa fa-user"></i>โปรไฟล์</a>
								</li>
								<li>
		...
		<aside class="main-sidebar" style="background-color: white;">
			...
			<section class="">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="ae"><a href="<?= site_url('repair_system/repairman'); ?>"><i class="fa fa-home fa-lg"></i>
							&nbsp;&nbsp;&nbsp;
							<strong> <span>หน้าหลัก</span> </strong> </a></li>


					<li><a href="<?= site_url('repair_system/repairman/list_all'); ?>"><i class="fa fa-list fa-lg"></i> &nbsp;&nbsp;&nbsp;
					...
					<li><a href="<?= site_url('repair_system/repairman/list_type'); ?>">
							<i class="fa fa-briefcase fa-lg"></i>&nbsp;&nbsp;&nbsp; <strong>
								<span>ประเภทงานแจ้งซ่อม</span></strong> </a>
					</li>


					<li><a href="<?= site_url('repair_system/repairman/token_list'); ?>">
					...
					<li><a href="<?= site_url('repair_system/repairman/profile'); ?>"><i class="fa fa-user fa-lg"></i>
							&nbsp;&nbsp;&nbsp;
							<strong> <span>โปรไฟล์</span></a></strong> </li>


					<li><a href="<?= site_url('repair_system/repairman/edit_password'); ?>"><i class="fa fa-key fa-lg"></i> &nbsp;&nbsp;&nbsp;
