...
<body class="hold-transition skin-red sidebar-mini">
    ...
    <strong><span>ผู้ดูแลระบบ</span></strong>  
</div> -->
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="ae"><a href="<?= site_url('repair_system/admin'); ?>"><i class="fa fa-home fa-lg"></i>
							&nbsp;&nbsp;&nbsp;
							<strong> <span>หน้าหลัก</span> </strong> </a></li>


					<li><a href="<?= site_url('repair_system/repair'); ?>"><i class="fa fa-wrench fa-lg"></i>&nbsp;&nbsp;&nbsp;
							<strong><span>แจ้งซ่อม</span> </strong> </a></li>

					<li><a href="<?= site_url('repair_system/admin/list_repair'); ?>"><i class="fa fa-history fa-lg"></i>&nbsp;&nbsp;&nbsp;
					...
					<li><a href="<?= site_url('repair_system/admin/list_all'); ?>"><i class="fa fa-list"></i> &nbsp;&nbsp;&nbsp;
							<strong> <span>รายการแจ้งซ่อม
					...
					<li><a href="<?= site_url('repair_system/admin/admin_list_user'); ?>"><i class="fa fa-group fa-lg"></i> &nbsp;&nbsp;&nbsp;
							<strong> <span>สมาชิก</span></strong> </a></li>

					<li><a href="<?= site_url('repair_system/admin/admin_list_type'); ?>">
							<i class="fa fa-briefcase fa-lg"></i>&nbsp;&nbsp;&nbsp; <strong>
								<span>ประเภทงานแจ้งซ่อม</span></strong> </a>
					</li>

					<li><a href="<?= site_url('repair_system/admin/admin_list_address'); ?>">

							<i class="fa fa-map-marker fa-lg"></i>&nbsp;&nbsp;&nbsp;
							
							<strong>
								<span>รายการสถานที่</span></strong> </a>
					</li>


					<li><a href="<?= site_url('repair_system/admin/token_list'); ?>">
							<i class="fa fa-wechat fa-lg"></i> &nbsp;&nbsp;&nbsp; <strong> <span>แจ้งเตือนไลน์กลุ่ม</span></strong>
						</a>
					</li>
					...
					<li><a href="<?= site_url('repair_system/admin/admin_edit_password'); ?>"><i class="fa fa-key fa-lg"></i> &nbsp;&nbsp;&nbsp;
