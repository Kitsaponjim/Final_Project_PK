...
<body class="hold-transition skin-red sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?= site_url('car_system/employee'); ?>" class="logo" style="background-color: white;">
	...
	<span style="color: green; font-size: small;">●</span>
        <strong><span style="font-size: small;">ผู้ใช้งานระบบ</span></strong>  
							...
							<ul class="dropdown-menu">
								<li>
									<a href="<?php echo site_url('car_system/employee/profile'); ?>"><i class="fa fa-user"></i>โปรไฟล์</a>
								</li>
								<li>
		...
		<aside class="main-sidebar" style="background-color: white;">
			...
			<section class="">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="ae"><a href="<?= site_url('car_system/employee'); ?>"><i class="fa fa-calendar fa-lg"></i>
							&nbsp;
							<strong> <span>ปฏิทินการใช้รถ</span> </strong> </a></li>

					<li><a href="<?= site_url('car_system/employee/list_car'); ?>"><i class="fa fa-car fa-lg"></i>
							&nbsp;
							<strong> <span>จองรถ</span></strong> </a></li>

					<li><a href="<?= site_url('car_system/employee/list_history_id'); ?>"><i class="fa fa-history fa-lg"></i> &nbsp;
					...
					<li><a href="<?= site_url('car_system/employee/profile'); ?>"><i class="fa fa-user fa-lg"></i>
							&nbsp;&nbsp;&nbsp;
							<strong> <span>โปรไฟล์</span></a></strong> </li>

					<li><a href="<?= site_url('car_system/employee/edit_password'); ?>"><i class="fa fa-key fa-lg"></i> &nbsp;&nbsp;&nbsp;
