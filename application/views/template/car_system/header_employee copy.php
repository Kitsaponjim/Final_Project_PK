...
<body class="hold-transition skin-red sidebar-mini">
    ...
    <span class="logo-lg" style="color: black;"><b>Reserve a car</b></span>
	
</a>


			
			<nav class="navbar navbar-static-top" style="background-color: #5c9dff;">
				<!-- Sidebar button-->
							...
							<ul class="dropdown-menu">
								...
								<li>
									<a href="<?php echo site_url('login/logout'); ?>"
										onclick="return confirm('คุณต้องการออกจากระบบหรือไม่!!!');"><i class="fa fa-sign-out"></i>ออกจากระบบ</a>
								</li>
							</ul>
						</li>
					</ul>
		...
		<aside class="main-sidebar" style="background-color: white;">
			...
			<section class="">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<strong><span>รายการรถในองค์กร</span> </strong> </a></li>

					<li><a href="<?= site_url('repair_system/admin/admin_list'); ?>"><i class="fa fa-check-square fa-lg"></i> &nbsp;
					<strong> 	<span>จองรถ
					...
					<li><a href="<?= site_url('repair_system/admin/admin_edit_password'); ?>"><i class="fa fa-code fa-lg"></i> &nbsp;
					<strong> <span>เปลี่ยนรหัสผ่าน</span></a></strong> </li>

							
					<li><a href="<?= site_url('login/logout'); ?>"
							onclick="return confirm('คุณต้องการออกจากระบบใช่หรือไม่');"><i class="fa fa-sign-out fa-lg"></i> &nbsp;
