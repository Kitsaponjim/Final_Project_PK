<div class="content-wrapper">
	<section class="content-header">
		<p
			...
			<strong style="flex: 1; display: inline;">ประวัติการจองรถ</strong>
		</p>
						...
						<table id="example1" class="table table-bordered table-striped dataTable" role="grid"
							...
							<tbody>
								...
								foreach ($data['data'] as $value) {
									...
									// $car_brand_a = $data_car_array[1];
									// $car_model_a = $data_car_array[2];
									// $car_type_a = $data_car_array[3];
									// $car_registration_a = $data_car_array[4];
									// $car_color_a = $data_car_array[5];
									// $car_number_seat_a = $data_car_array[6];
									// $car_other_a = $data_car_array[7];
							
									// $driver_name_a = $data_driver_array[0];
									// $driver_tel_a = $data_driver_array[1];
									// $driver_history_a = $data_driver_array[2];						
									// $id_driver = $value->id_driver;
									// $driver_name = $value->driver_name;
									// $driver_tel = $value->driver_tel;
									// $driver_history = $value->driver_history;
									...
									if ($car_id == $car_id_a) {
										...
										// 1,BMW (บีเอ็มดับเบิลยู),รถเก๋ง,รถเก๋ง,กท 11 ชุมพร,ดำ,5,มีสติกเกอร์
...
<div class="modal fade" id="popupModal_car" tabindex="-1" role="dialog" aria-labelledby="popupModalLabel"
	...
	<img id="src_r" alt="Driver Image" style="max-width: 200%; max-height: 200px; font-size: 80px; color: #4281ff;">
</div> -->
	...
	<img id="src_r" alt="Driver Image" style="max-width: 200%; max-height: 200px; font-size: 80px; color: #4281ff;">
				...
				<i id="" class="fa fa-car" style="max-width: 200%; max-height: 200px; font-size: 80px; color: #4281ff;"> -->


					<!-- <img id="src_r"  style="max-width: 200%; max-height: 200px; font-size: 80px; color: #4281ff;"> -->
...
<script>
	...
	$('#popupModal_car').on('show.bs.modal', function (event) {
		...
		if (src_r == 'fa fa-car') {
			// If src_r is 'fa fa-car', show the font-awesome icon
			imageContainer.hide();
			fontAwesomeIcon.show();
		} else {
			// If src_r is an image, show the image
			imageContainer.show();
		...
		if (src_driver == 'fa fa-user') {
			// If src_driver is 'fa fa-user', show the font-awesome icon
			imageContainerDriver.hide();
			fontAwesomeIconDriver.show();
		} else {
			// If src_driver is an image, show the image
	...
	function OnEdit() {
		...
		window.location = "<?= base_url('car_system/Admin/edit_request/'); ?>" + case_id;
	}
