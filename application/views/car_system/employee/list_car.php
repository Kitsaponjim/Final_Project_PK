	...
	<section class="content">
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<form action="<?= site_url('car_system/employee/list_car'); ?>" method="post"
								...
								<div class="box custom-box">
									<div class="box-body">
										...
										<p style="font-size: 20px; display: flex; align-items: center; margin-top: 2px;">
											...
											<?= $car_number_seat ? $car_number_seat : '-'; ?>ที่นั่ง
											</strong>
...
<script>
	function checkDates(car_id) {
		...
		if (!start_date || !end_date) {
			...
			$('#start_date').focus();
			window.location = "<?= base_url(); ?>car_system/employee/list_car";
		}
