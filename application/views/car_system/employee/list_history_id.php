						...
						<table id="example1" class="table table-bordered table-striped dataTable" role="grid"
							...
							<tbody>
								...
								foreach ($data['data'] as $value) {
									...
									if($status_reserve != 1 && $car_id != $car_id_a) {
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title" id="popupModalLabel" style="color:red;">ยกเลิกการจอง</h3>
			</div>
			<div class="modal-body">
				...
				<div class="form-group">
					<label for="" style="font-size:22px;"><strong class="text-danger">*</strong>กรอกเหตุผลการยกเลิกการจอง</label>
...
<script>
		...
		if (confirm('คุณต้องการยกเลิกการจองใช่หรือไม่')) {
			...
			$.ajax({
				...
				success: function (data) {
					...
					window.location = "<?= base_url(); ?>car_system/employee/list_history_id";
				}
			});
			return false;
		}
	...
	function OnEdit() {
		...
		window.location = "<?= base_url('car_system/employee/edit_request/'); ?>" + case_id;
	}
