<div class="content-wrapper">
    ...
    border-radius: 10px; /* ปรับค่าตามที่คุณต้องการให้เหมาะสม */
		...
		.custom-box {
						...
						<?php
						$name_car = $user_status['user_status']->name_car;
						...
						$user_status_car = $data['query']->user_status_car;
...
<script>
	function onEdit(id) {
		...
		window.location = "<?= base_url(); ?>car_system/employee/profile_edit/" + id;
